<template>
	<div class='app-container'>
		<el-form v-show='showSearch' ref='queryRef' :inline='true' :model='queryParams' label-width='68px'>
			...
			<el-form-item label='文章专属二维码地址' prop='qrcodePath'>
				<el-input
						v-model='queryParams.qrcodePath'
						clearable
						placeholder='请输入文章专属二维码地址'
						@keyup.enter='handleQuery'
				/>
			</el-form-item>
			...
			<el-form-item label='文章简介，最多200字' prop='description'>
				<el-input
		...
		<el-table v-loading='loading' :data='articleList' @selection-change='handleSelectionChange'>
			...
			<el-table-column align='center' label='版本id' prop='uuid' />
			...
			<el-table-column align='center' label='当前文章阅读类型' prop='readType' />
			<el-table-column align='center' label='当前文章适用的编辑器类型' prop='editorType' />
			<el-table-column align='center' label='文章专属二维码地址' prop='qrcodePath' />
			<el-table-column align='center' label='${comment}' prop='isMarkdown' />
			<el-table-column align='center' label='文章内容' prop='content' />
			<el-table-column align='center' label='markdown版的文章内容' prop='contentMd' />
			...
			<el-table-column align='center' label='文章简介，最多200字' prop='description' />
		...
		<el-dialog v-model='open' :title='title' append-to-body width='500px'>
			<el-form ref='articleRef' :model='form' :rules='rules' label-width='80px'>
				...
				<el-form-item label='markdown版的文章内容' prop='contentMd'>
